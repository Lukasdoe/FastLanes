...
// 	manual::delta::scalar_delta(helper::delta_08, output08,
// helper::bases_08); 	for (int i = 0; i < 1024; ++i) {
// ASSERT_EQ(output08[i], helper::array_08[i]);
// 	}
// }

// TEST_F(rsum, test_scalar_delta_manual_16) {
// 	manual::delta::scalar_delta(helper::delta_16, output16,
// helper::bases_16); 	for (int i = 0; i < 1024; ++i) {
// ASSERT_EQ(output16[i], helper::array_16[i]);
// 	}
// }

// TEST_F(rsum, test_scalar_delta_manual_32) {
// 	manual::delta::scalar_delta(helper::delta_32, output32,
// helper::bases_32); 	for (int i = 0; i < 1024; ++i) {
// ASSERT_EQ(output32[i], helper::array_32[i]);
// 	}
// }

// TEST_F(rsum, test_scalar_delta_manual_64) {
// 	manual::delta::scalar_delta(helper::delta_64, output64,
// helper::bases_64); 	for (int i = 0; i < 1024; ++i) {
...
// this implementation fails the test as the instruction has different
// behaviour.

// TEST_F(rsum, test_scalar_avx512_d1_08) {
//	manual::delta::avx512_d1_08(helper::delta_08, output08,
// helper::bases_08); 	for (int i = 0; i < 1024; ++i) {
// ASSERT_EQ(output08[i], helper::array_08[i]);
//	}
// }
...
//	manual::delta::avx512_d1_16(helper::delta_16, output16,
// helper::bases_16); 	for (int i = 0; i < 1024; ++i) {
// ASSERT_EQ(output16[i], helper::array_16[i]);
//	}
// }
...
//   manual::delta::four_cursor_delta(helper::delta_08, output08,
//                                    helper::bases_08);
//   for (int i = 0; i < 1024; ++i) {
//     ASSERT_EQ(output08[i], helper::array_08[i]);
//   }
...
//   manual::delta::four_cursor_delta(helper::delta_16, output16,
//                                    helper::bases_16);
//   for (int i = 0; i < 1024; ++i) {
//     ASSERT_EQ(output16[i], helper::array_16[i]);
//   }
...
//   manual::delta::four_cursor_delta(helper::delta_32, output32,
//                                    helper::bases_32);
//   for (int i = 0; i < 1024; ++i) {
//     ASSERT_EQ(output32[i], helper::array_32[i]);
//   }
...
//   manual::delta::four_cursor_delta(helper::delta_64, output64,
//                                    helper::bases_64);
//   for (int i = 0; i < 1024; ++i) {
//     ASSERT_EQ(output64[i], helper::array_64[i]);
//   }
